...
public class Vol {
    ...
    public void modificarVol() throws ParseException {
        ...
        do{
            System.out.println("Digueu-me el nou codi del vol: "); codi = DADES.next();
        }while((codi.length()<6) || (codi.length()>7));
        
        System.out.println("Digueu-me el nou dia de sortida del vol (dd-MM-yyyy): "); 
        dataSortida = new SimpleDateFormat("dd-MM-yyyy").parse(new Scanner(System.in).nextLine());
        ...
        System.out.println("Digueu-me el nou dia d'arribada del vol (dd-MM-yyyy): "); 
        dataArribada = new SimpleDateFormat("dd-MM-yyyy").parse(new Scanner(System.in).nextLine());
        
        do{
            System.out.println("Digueu-me la nova hora d'arribada del vol (24H): "); h = DADES.nextInt();
        }while((h<0) || (h>23));
        do{
